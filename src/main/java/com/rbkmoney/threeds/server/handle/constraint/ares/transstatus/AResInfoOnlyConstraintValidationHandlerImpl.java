...
public class AResInfoOnlyConstraintValidationHandlerImpl implements AResConstraintValidationHandler {
    ...
    private boolean isVisaCrutch(ThreeDSRequestorChallengeInd threeDSRequestorChallengeInd) {
        return threeDSRequestorChallengeInd == ThreeDSRequestorChallengeInd.RESERVED_FOR_DS_USED_82 && providerHolder.getEnvironmentProperties().getThreeDsServerRefNumber().equals("3DS_LOA_SER_DIPL_020200_00236");
    }
}
