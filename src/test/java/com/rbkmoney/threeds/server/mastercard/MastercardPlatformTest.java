...
//                        .json(new GetChallengeFlow().responseToClient()));
        ...
        System.out.println(frictionlessFlow.readPArq(testCase));
        System.out.println(frictionlessFlow.readAReq(testCase));
        System.out.println(frictionlessFlow.readARes(testCase));
        System.out.println(frictionlessFlow.readPArs(testCase));
