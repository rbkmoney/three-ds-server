...
@SpringBootTest(
        ...
        classes = AbstractMastercardPlatformConfig.TestConfig.class,
        properties = "spring.main.allow-bean-definition-overriding=true")
@ContextConfiguration(initializers = AbstractMastercardPlatformConfig.Initializer.class)
@TestPropertySource("classpath:application.yml")
@AutoConfigureMockMvc
public abstract class AbstractMastercardPlatformConfig {
