package com.rbkmoney.threeds.server.flow.testplatform.frictionless.happycase;
...
public class TestPlatformFrictionlessFlowTest extends AbstractTestPlatformConfig {
    ...
    public void frictionlessFlowDefaultHandleTest() throws Exception {
        ...
        String path = "flow/testplatform/frictionless/happycase/default-handle/";
        ...
        mockMvc.perform(request)
                .andExpect(content()
                        .json(frictionlessFlow.responseFromThreeDsServer()));
    }
}
